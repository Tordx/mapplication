  ...
  const InfoModal = ({ isVisible, onClose, info, onPress }) => (
    <Modal visible={isVisible} onRequestClose={onClose} transparent animationType='slide'>
      <View  style = {{justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%', backgroundColor: '#00000079',}}>
  ...
  const Map = () => {
    ...
    useEffect(() => {
      ...
      const southwest = [119.9435, 16.1299];
      const northeast = [120.0214, 16.1798];
      const bounds = [southwest, northeast];
    
      const setBoundingBox = () => {
        mapRef.current.setVisibleCoordinateBounds(bounds, 10, 10, 10, 10);
      };
